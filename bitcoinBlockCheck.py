...
## Blockheader:
version = str2le(hex(int("536870912"))[2:])
hashPrevBlock = str2le("00000000000000000152cd3a2ca9a0e9495d74570a84251e2f653e19c333362a")#.decode("hex")
...
nonce = str2le(hex(int("3038619565"))[2:])
